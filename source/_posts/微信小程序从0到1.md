...
* __与其他第三方应用进行交互__
  ...
  * 小程序唤起 app：
    ...
    * 从 app 分享出去的小程序，可以调起 app：需要将 `<button>` 组件 open-type 的值设置为 launchApp，可通过 app-parameter 参数给 App 传参（[详情](https://developers.weixin.qq.com/miniprogram/dev/framework/open-ability/launchApp.html)）
